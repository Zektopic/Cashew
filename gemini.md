...
**Next Planned Step:** Audit remaining custom widgets (e.g., individual `CategoryLimits` or progress bars) or search for any remaining raw `Text` rendering of currency/percentages that bypasses `convertToMoney`/`convertToPercent`.
